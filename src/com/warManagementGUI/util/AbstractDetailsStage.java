...
public abstract class AbstractDetailsStage {
    ...
    public AbstractDetailsStage(String title, int width, int height) {
        ...
        // Create root pane with absolute posting
        rootPane = new Pane();
    ...
    protected Button createButton(String text, double x, double y, double w, double h,
    ...
    protected Button createButton(String text, Font font, double x, double y, double w, double h,
            EventHandler<ActionEvent> handler) {
    ...
    protected Button createButton(String text, Font font, Color textColor, Color bgColor, double x, double y, double w,
    ...
    protected <T extends AbstractDetailsStage> void createNavButton(String name, Class<T> cls, double x, double y,
            double w, double h) {
