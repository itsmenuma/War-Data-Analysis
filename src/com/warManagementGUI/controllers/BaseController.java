...
public abstract class BaseController {
    ...
    protected void navigateToScene(String fxmlPath, String title, Node currentNode) throws IOException {
        ...
        // Get the new controller and verify authentication state
        BaseController newController = loader.getController();
        if (newController != null) {
            // The controller should inherit the singleton AuthService automatically
            // Force update user info if the controller has that method
            try {
                ...
                // updateUserInfo method may not exist in all controllers, that's fine
        ...
        // Center the stage if it's not maximized
