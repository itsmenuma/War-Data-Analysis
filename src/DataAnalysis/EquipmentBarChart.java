...
public class EquipmentBarChart extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
		...
		int yAxisTitleWidth = labelFontMetrics.stringWidth(yAxisTitle);
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add(new BarChartExample(data, "Equipment Status Count"));
